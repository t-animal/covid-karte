...
function mapIdToRkiObjectId(mapId: number) {
  switch (mapId) {
    ...
    case 372: return 352; //	"SK Chemnitz",
    case 370: return 353; //	"LK Erzgebirgskreis",
    case 374: return 354; //	"LK Mittelsachsen",
    case 377: return 355; //	"LK Vogtlandkreis",
    case 373: return 356; //	"LK Zwickau",
    case 383: return 357; //	"SK Dresden",
    case 382: return 358; //	"LK Bautzen",
    case 384: return 359; //	"LK Görlitz",
    case 387: return 360; //	"LK Meißen",
    case 390: return 361; //	"LK Sächsische Schweiz-Osterzgebirge",
    case 394: return 362; //	"SK Leipzig",
    case 395: return 363; //	"LK Leipzig",
    case 392: return 364; //	"LK Nordsachsen",

    case 349: return 365; //	"SK Dessau-Roßlau",
    case 354: return 366; //	"SK Halle",
    case 364: return 367; //	"SK Magdeburg",
    case 360: return 368; //	"LK Altmarkkreis Salzwedel",
    case 346: return 369; //	"LK Anhalt-Bitterfeld",
    case 361: return 370; //	"LK Börde",
    case 353: return 371; //	"LK Burgenlandkreis",
    case 362: return 372; //	"LK Harz",
    case 363: return 373; //	"LK Jerichower Land",
    case 355: return 374; //	"LK Mansfeld-Südharz",
    case 356: return 375; //	"LK Saalekreis",
    case 347: return 376; //	"LK Salzlandkreis",
    case 368: return 377; //	"LK Stendal",
    case 351: return 378; //	"LK Wittenberg",
